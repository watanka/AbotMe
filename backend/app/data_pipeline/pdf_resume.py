...
class ChromaVectorStoreSaver(VectorStoreSaver):
    def __init__(self, persist_dir: str = "chroma_data", collection_name: str = "resume"):
        self.persist_dir = persist_dir
        self.collection_name = collection_name
    def save(self, docs: List[str]):
        client = chromadb.PersistentClient(path=self.persist_dir, settings=Settings(allow_reset=True))
